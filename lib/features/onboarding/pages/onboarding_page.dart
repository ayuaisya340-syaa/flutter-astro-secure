...
import 'package:reminder_kelompok/features/onboarding/bloc/onboarding/onboarding_bloc.dart';
        ...
        children: [
          Expanded(
            child: CustomButton(
              ...
              textColor: primaryThemeColor,
              onPressed: () {
                // 1. Beritahu BLoC bahwa Onboarding sudah selesai
                context.read<OnBoardingBloc>().add(
                  const OnBoardingEvent.completed(),
                );

                // 2. Gunakan pushReplacement agar user tidak bisa "back" ke halaman Onboarding
