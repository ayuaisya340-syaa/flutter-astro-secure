...
import 'package:reminder_kelompok/features/child_mode/pages/about_lumi_page.dart';
...
import 'package:reminder_kelompok/core/components/custom_back_button.dart';
import '../../../core/components/star_paintar.dart' show StarPainter;

// TODO: Pastikan path import ini sesuai dengan lokasi file about_lumi_page.dart di project-mu
  ...
  void _onCharacterTap() {
    _characterScaleController.reverse().then((_) {
      _characterScaleController.forward().then((_) {
        // --- NAVIGASI KE HALAMAN ABOUT LUMI (Koleksi Karakter) ---
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const AboutLumiPage()),
        );
      });
    });
  }
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  GestureDetector(
                    onTap:
                        _onCharacterTap, // <--- Aksi ini sekarang memanggil _onCharacterTap
